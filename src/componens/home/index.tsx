...
import ReadyTocollaborate from "../contacts/rotatingWheel";
import ProjectsSection from "../projects";

const HomeContainer = () => {
  return (
    <div className="relative min-h-screen w-full bg-gray-950/95">
      <div className="bg-[url('/pattern-code.png')] inset-0 opacity-[0.03] absolute" />
      <div className="w-full text-center space-y-6 xl:pt-8 mt-[100px] p-6">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <button className="py-3 px-5 border-green-600 border hover:bg-green-600 text-green-600 font-bold rounded-lg transition-all flex gap-2 animated fadeInUp delay500">
            {"</>"}&nbsp;&nbsp;Contact Me
          </button>
        </div>
      </div>
