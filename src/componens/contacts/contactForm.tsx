import { FaEnvelope, FaPhoneAlt, FaMapMarkerAlt, FaGithub, FaLinkedin, FaTwitter, FaDev, FaPaperPlane } from "react-icons/fa";
const ContactForm = () => {
    return (
        <section className="bg-[#0d1117] text-white py-16 px-6 md:px-20" id="contact">
            <div className="max-w-6xl mx-auto border border-gray-700 rounded-lg p-6 md:p-10">
